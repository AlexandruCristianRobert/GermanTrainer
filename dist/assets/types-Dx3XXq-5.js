...
`,[d("input, textarea",`
 ...
 `),A("&:-webkit-autofill ~",[d("placeholder","display: none;")])]),D("round",[Q("textarea","border-radius: calc(var(--n-height) / 2);")]),d("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),D("textarea",[d("placeholder","overflow: visible;")]),Q("autosize","width: 100%;"),D("autosize",[d("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `)]),A("&:hover",[d("state-border","border: var(--n-border-hover);")]),D("focus","background-color: var(--n-color-focus);",[d("state-border",`
 ...
 `),["warning","error"].map(t=>D(`${t}-status`,[Q("disabled",[x("base-loading",`
