...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    notes: [
      ...
      '<strong>You translate, the AI grades.</strong> You work through the sentences one at a time: read the English, type the German, submit. The AI judges each answer on meaning <em>and</em> correct preposition + case — accepting valid rewordings, flagging wrong case — and shows instant ✓/✗ with a one-line note plus the reference translation before you advance. If the AI is unreachable, grading falls back to an exact match so the quiz always finishes.',
