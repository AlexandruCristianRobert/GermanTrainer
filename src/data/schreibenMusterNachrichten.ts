...
export const SCHREIBEN_MUSTER_NACHRICHTEN: Musternachricht[] = [
  {
    ...
    skeleton: [
      ...
      'Entschuldigung für das Fehlen und die Kurzfristigkeit',
    ...
    segments: [
      ...
      { t: 'Bitte entschuldigen Sie ', layer: 'mittel',
        noteDe: 'Das Nachrichtenmittel der Entschuldigung nennt zuerst das Fehlen selbst, dann erst die Kurzfristigkeit — genau die Reihenfolge, die der erste Inhaltspunkt verlangt.' },
      { t: 'mein Fehlen und dass ich Ihnen erst heute Bescheid gebe. ' },
      { t: 'Mir ist bewusst, wie wichtig diese Besprechung für die Planung des nächsten Quartals ist.' },
      { t: '\n\n' },
      { t: 'Ich habe am Freitagvormittag einen Facharzttermin, ' },
  ...
  },
  {
    ...
    segments: [
      ...
      { t: 'Seit dem Wechsel des Anbieters hat die Qualität in der Betriebskantine deutlich nachgelassen.' },
      { t: '\n\n' },
      ...
      { t: '. ' },
      { t: 'Mehrere Kolleginnen und Kollegen essen deshalb inzwischen auswärts, ' },
      { t: 'sodass die Kantine weiter an Zuspruch verliert', layer: 'struktur',
        noteDe: 'Der sodass-Satz macht die Folgekette explizit: kurze Pause, langes Anstehen, weniger Gäste — so wird aus dem eigenen Ärger ein Problem des Betriebs.' },
      { t: '.' },
      { t: '\n\n' },
  ...
  },
  {
    ...
    segments: [
      ...
      { t: 'Guten Tag, Frau Neumann,', layer: 'hoeflichkeit',
        noteDe: 'Die moderne neutrale Anrede passt zu einer erbetenen Idee im eigenen Haus. Dazu passt der etwas leichtere Gruß „Freundliche Grüße" — „Mit freundlichen Grüßen" wäre hier ebenfalls korrekt.' },
      { t: '\n' },
      ...
      { t: 'Freundliche Grüße', layer: 'hoeflichkeit',
        noteDe: 'Die leichtere Entsprechung zu „Guten Tag, Frau …"; „Mit freundlichen Grüßen" ginge auch. Ein echter Registerbruch wäre erst „Sehr geehrte Frau …" mit „Liebe Grüße".' },
      { t: '\nMarco Lehner' }
    ]
  },
  {
    ...
    segments: [
      ...
      { t: 'der theoretische Teil am dritten Tag: Die Präsentation dauerte sehr lange, ' },
