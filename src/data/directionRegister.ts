...
export const DIRECTION_REGISTER: DwRegisterItem[] = [
  ...
  { id: 'dwr-7', verdict: 'standard', level: 'A2', pair: null,
  ...
  { id: 'dwr-28', verdict: 'wrong', level: 'B1', pair: 'aus',
    ...
    explanation: '„hinraus" existiert nicht — „raus" ERSETZT hinaus/heraus. / "hinraus" does not exist; the r-form already replaced the full compound — correct: "hinaus" (or spoken "raus").' },
  { id: 'dwr-29', verdict: 'wrong', level: 'B1', pair: 'auf',
    phrase: 'Er ist die Leiter schnell hinrauf geklettert.',
    explanation: '„hinrauf" existiert nicht — „rauf" ERSETZT hinauf/herauf. / "hinrauf" does not exist; the r-form already replaced the full compound — correct: "hinauf" (or spoken "rauf").' },
  { id: 'dwr-30', verdict: 'wrong', level: 'B1', pair: 'unter',
    phrase: 'Sie ist die Treppe hinrunter gefallen.',
    explanation: '„hinrunter" existiert nicht — „runter" ERSETZT hinunter/herunter. / "hinrunter" does not exist; the r-form already replaced the full compound — correct: "hinunter" (or spoken "runter").' },
  { id: 'dwr-31', verdict: 'wrong', level: 'B1', pair: 'über',
    phrase: 'Er ist schnell hinrüber gelaufen, um ihr zu helfen.',
    explanation: '„hinrüber" existiert nicht — „rüber" ERSETZT hinüber/herüber. / "hinrüber" does not exist; the r-form already replaced the full compound — correct: "hinüber" (or spoken "rüber").' },
  ...
  { id: 'dwr-38', verdict: 'wrong', level: 'C1', pair: 'aus',
    ...
    explanation: '„herraus" existiert nicht — „raus" ERSETZT bereits heraus/hinaus. / "herraus" does not exist; "raus" already replaced the full compound — correct: "heraus" (or spoken "raus").' },
  { id: 'dwr-39', verdict: 'wrong', level: 'C1', pair: 'auf',
    phrase: 'Komm doch herrauf, das Wetter ist super!',
    explanation: '„herrauf" existiert nicht — „rauf" ERSETZT bereits herauf/hinauf. / "herrauf" does not exist; "rauf" already replaced the full compound — correct: "herauf" (or spoken "rauf").' },
]
