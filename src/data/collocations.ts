...
export const COLLOCATIONS: Collocation[] = [
  ...
  { id: "sich-gewoehnen-an", word: "sich gewöhnen", english: "to get used to", role: "verb", preposition: "an", case: "accusative", level: "B1", example: "Ich gewöhne mich an das neue Klima." },
  ...
  { id: "teilnehmen-an", word: "teilnehmen", english: "to take part in", role: "verb", preposition: "an", case: "dative", level: "B1", example: "Wir nehmen an dem Wettbewerb teil." },
  ...
  { id: "sich-beteiligen-an", word: "sich beteiligen", english: "to participate in", role: "verb", preposition: "an", case: "dative", level: "B2", example: "Alle beteiligen sich an dem Projekt." },
  ...
  { id: "mitwirken-an", word: "mitwirken", english: "to collaborate on", role: "verb", preposition: "an", case: "dative", level: "C1", example: "Viele Künstler wirken an dem Film mit." },
  ...
  { id: "sich-festhalten-an", word: "sich festhalten", english: "to hold on to", role: "verb", preposition: "an", case: "dative", level: "B2", example: "Halt dich an dem Geländer fest." },
  ...
  { id: "sich-freuen-auf", word: "sich freuen", english: "to look forward to", role: "verb", preposition: "auf", case: "accusative", level: "B1", example: "Wir freuen uns auf das Wochenende." },
  ...
  { id: "ankommen-auf", word: "ankommen", english: "to depend on", role: "verb", preposition: "auf", case: "accusative", level: "B2", example: "Es kommt auf das Wetter an." },
  ...
  { id: "sich-beschraenken-auf", word: "sich beschränken", english: "to limit oneself to", role: "verb", preposition: "auf", case: "accusative", level: "C1", example: "Wir beschränken uns auf das Wesentliche." },
  ...
  { id: "sich-streiten-um", word: "sich streiten", english: "to argue over", role: "verb", preposition: "um", case: "accusative", level: "B2", example: "Sie streiten sich um das Erbe." },
  { id: "sich-drehen-um", word: "sich drehen", english: "to be about (revolve around)", role: "verb", preposition: "um", case: "accusative", level: "B2", example: "Alles dreht sich um das Geld." },
  ...
  { id: "sich-vertiefen-in", word: "sich vertiefen", english: "to immerse oneself in", role: "verb", preposition: "in", case: "accusative", level: "C1", example: "Er vertieft sich in das Buch." },
  ...
  { id: "sich-beschweren-bei", word: "sich beschweren", english: "to complain to", role: "verb", preposition: "bei", case: "dative", level: "B2", example: "Sie beschwert sich bei dem Chef." },
  ...
  { id: "sich-erkundigen-bei", word: "sich erkundigen", english: "to inquire with (someone)", role: "verb", preposition: "bei", case: "dative", level: "B2", example: "Erkundige dich bei dem Amt nach der Frist." },
  ...
  { id: "gehoeren-zu", word: "gehören", english: "to belong to / be part of", role: "verb", preposition: "zu", case: "dative", level: "B1", example: "Dieses Zimmer gehört zu der Wohnung." },
  { id: "passen-zu", word: "passen", english: "to go with / suit", role: "verb", preposition: "zu", case: "dative", level: "B1", example: "Die Krawatte passt gut zu dem Hemd." },
  ...
  { id: "beitragen-zu", word: "beitragen", english: "to contribute to", role: "verb", preposition: "zu", case: "dative", level: "B2", example: "Jeder trägt zu dem Erfolg bei." },
  ...
  { id: "sich-beteiligen-an-firma", word: "sich beteiligen", english: "to hold a stake in", role: "verb", preposition: "an", case: "dative", level: "C1", example: "Der Investor beteiligt sich an dem Start-up." },
  ...
  { id: "ausnehmen-von", word: "ausgehen", english: "to set out from (assume)", role: "verb", preposition: "von", case: "dative", level: "B2", example: "Wir gehen von dem schlimmsten Fall aus." },
  ...
  { id: "Stellung-nehmen-zu", word: "Stellung nehmen", english: "to take a stance on", role: "verb", preposition: "zu", case: "dative", level: "C1", example: "Sie nimmt Stellung zu dem Vorwurf." },
  ...
  { id: "einfuehren-in", word: "einführen", english: "to introduce into", role: "verb", preposition: "in", case: "accusative", level: "B2", example: "Der Mentor führt sie in das Thema ein." },
  ...
  { id: "leiden-unter-druck", word: "ächzen", english: "to groan under", role: "verb", preposition: "unter", case: "dative", level: "C1", example: "Die Brücke ächzt unter dem Gewicht." },
  ...
  { id: "sich-konzentrieren-auf-ziel", word: "fokussieren", english: "to focus on", role: "verb", preposition: "auf", case: "accusative", level: "C1", example: "Wir fokussieren auf das Wesentliche." },
  ...
  { id: "sich-aergern-ueber-fehler", word: "sich grämen", english: "to fret over", role: "verb", preposition: "über", case: "accusative", level: "C1", example: "Er grämt sich über den verlorenen Job." },
  ...
  { id: "verfuegen-ueber-zeit", word: "verfügen", english: "to have available (little)", role: "verb", preposition: "über", case: "accusative", level: "C1", example: "Er verfügt nur über wenig Zeit." },
  ...
  { id: "sich-sehnen-nach-ruhe", word: "lechzen", english: "to yearn for", role: "verb", preposition: "nach", case: "dative", level: "C1", example: "Die Erde lechzt nach Regen." },
  { id: "verlangen-nach-mehr", word: "dürsten", english: "to thirst for", role: "verb", preposition: "nach", case: "dative", level: "C1", example: "Er dürstet nach Wissen." },
  ...
  { id: "sich-verabschieden-von-traum", word: "Abstand nehmen", english: "to back away from", role: "verb", preposition: "von", case: "dative", level: "C1", example: "Wir nehmen Abstand von dem Plan." },
  ...
  { id: "warten-auf-antwort", word: "harren", english: "to await", role: "verb", preposition: "auf", case: "accusative", level: "C1", example: "Wir harren auf eine baldige Antwort." },
  ...
  { id: "passen-zu-stil", word: "passen", english: "to match (style)", role: "verb", preposition: "zu", case: "dative", level: "B1", example: "Diese Schuhe passen nicht zu dem Kleid." },
  ...
  { id: "sich-aergern-ueber-sich", word: "sich grämen", english: "to be vexed about", role: "verb", preposition: "über", case: "accusative", level: "C1", example: "Sie grämt sich über ihren Fehler im Spiel." },
  { id: "sich-freuen-ueber-lob", word: "frohlocken", english: "to rejoice at", role: "verb", preposition: "über", case: "accusative", level: "C1", example: "Die Menge frohlockt über den Sieg." },
  ...
  { id: "begeistert-von", word: "begeistert", english: "enthusiastic about", role: "adjective", preposition: "von", case: "dative", level: "B2", example: "Die Kinder sind begeistert von dem Zirkus." },
  ...
  { id: "beteiligt-an", word: "beteiligt", english: "involved in", role: "adjective", preposition: "an", case: "dative", level: "C1", example: "Er war an dem Projekt beteiligt." },
  { id: "schuld-an", word: "schuld", english: "to blame for", role: "adjective", preposition: "an", case: "dative", level: "B2", example: "Du bist schuld an dem Unfall." },
  ...
  { id: "die-teilnahme-an", word: "die Teilnahme", english: "participation in", role: "noun", preposition: "an", case: "dative", level: "B2", example: "Die Teilnahme an dem Kurs ist freiwillig." },
  ...
  { id: "die-einladung-zu", word: "die Einladung", english: "invitation to", role: "noun", preposition: "zu", case: "dative", level: "B1", example: "Danke für die Einladung zu dem Fest." },
  ...
  { id: "der-zugang-zu", word: "der Zugang", english: "access to", role: "noun", preposition: "zu", case: "dative", level: "B2", example: "Alle haben Zugang zu dem Internet." },
  ...
  { id: "der-beitrag-zu", word: "der Beitrag", english: "contribution to", role: "noun", preposition: "zu", case: "dative", level: "B2", example: "Sie leistet einen Beitrag zu dem Erfolg." },
  ...
  { id: "die-einsicht-in", word: "die Einsicht", english: "insight into", role: "noun", preposition: "in", case: "accusative", level: "C1", example: "Er gewinnt Einsicht in das Problem." },
  ...
  { id: "die-kritik-an", word: "die Kritik", english: "criticism of", role: "noun", preposition: "an", case: "dative", level: "B2", example: "Die Kritik an dem Plan ist berechtigt." },
