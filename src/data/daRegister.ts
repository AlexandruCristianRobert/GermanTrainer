...
export const DA_REGISTER: RegisterItem[] = [
  ...
  { id: 'rg-18', verdict: 'spoken', level: 'C1',
    ...
    explanation: 'Norddeutsche/umgangssprachliche wo-Spaltung "wo … von" statt "wovon". Standard: "Wovon redet ihr?" / wo-split; spoken only.' },
  ...
  { id: 'rg-31', verdict: 'wrong', level: 'B2',
    phrase: 'Worauf wartest du denn noch? Etwa auf deinen Bruder?',
  ...
  { id: 'rg-32', verdict: 'wrong', level: 'B2',
    phrase: 'Wo ist denn deine kleine Schwester? — Keine Ahnung, ich habe schon überall danach gesucht.',
    explanation: 'Nicht "danach", sondern "nach ihr": Ein da-Kompositum kann keine Person vertreten. / A da-compound cannot stand for a person — use "nach ihr".' },
