...
export const DA_PERSON_CASE: PersonCaseItem[] = [
  ...
  { id: 'pc-sich-freuen-auf', collocationId: 'sich-freuen-auf', level: 'B1', cue: 'es',
    frame: 'Das Enkelkind kommt zu Besuch; die Großeltern freuen sich schon riesig ___.' },
  { id: 'pc-sich-kuemmern-um', collocationId: 'sich-kuemmern-um', level: 'B1', cue: 'es',
    frame: 'Das Baby ist noch so klein, deshalb kümmert sich die Oma liebevoll ___.' },
  ...
  { id: 'pc-gehoeren-zu', collocationId: 'gehoeren-zu', level: 'B1', cue: 'wir',
    frame: 'Komm ruhig mit, du gehörst doch einfach ___!' },
  ...
  { id: 'pc-spielen-mit', collocationId: 'spielen-mit', level: 'B1', cue: 'wir',
    frame: 'Komm doch her und spiel ___!' },
  ...
  // adjectives
  { id: 'pc-stolz-auf', collocationId: 'stolz-auf', level: 'B1', cue: 'es',
    frame: 'Das kleine Mädchen hat den Wettbewerb gewonnen; die ganze Familie ist unglaublich stolz ___.' },
  ...
  { id: 'pc-freundlich-zu', collocationId: 'freundlich-zu', level: 'B1', cue: 'Sie',
    frame: 'Der Beamte am Schalter war ausgesprochen freundlich ___.' },
  ...
  { id: 'pc-der-respekt-vor', collocationId: 'der-respekt-vor', level: 'B2', cue: 'Sie',
    frame: 'Für Ihre Lebensleistung habe ich großen Respekt ___.' },
