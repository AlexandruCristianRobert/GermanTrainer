...
const TYPE_LABEL: Record<QuizHistoryType, string> = {
  ...
  'dac-formation': 'da-compound formation',
  'dac-match': 'da-compound matching',
  'dac-substitution': 'da-compound gap-fill',
  'dac-neighbors': 'da-compound near-neighbor choice',
  'dac-case': 'da-compound case',
  'dac-pronoun-case': 'da-compound pronoun case',
  'dac-article': 'da-compound article fill',
  'dac-transform': 'da-compound thing-or-person transform',
  'dac-wo-question': 'da-compound wo-question formation',
  'dac-dialogue': 'da-compound dialogue completion',
  ...
  'dac-homograph': 'da-compound · homograph discrimination (damit/darum/dabei/dagegen: compound vs connector reading)',
  'dac-register': 'da-compound · register judgment (standard/spoken-only/always-wrong)',
  'dac-relative': 'da-compound · relative-clause wo-form vs preposition+pronoun',
  ...
  'verb-remedial': 'verb · remedial weak-point drill',
  ...
  'schreiben-teil2': 'Schreiben Teil 2 — a semi-formal message of at least 100 words answering a workplace situation with four content points (score 0-100, Goethe B2 rubric)',
