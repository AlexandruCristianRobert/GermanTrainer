...
export const USER_DATA_KEYS = [
  ...
  'sprechenTeil1Setup',
  'sprechenTeil2Setup',
  // sprechen custom topics / Vortragsthemen
  'gt:sprechenCustomTopics',
  'gt:sprechenCustomVortragsthemen',
...
const KEY_LABELS: Record<UserDataKey, { label: string; group: string }> = {
  ...
  sprechenTeil1Setup: { label: 'Sprechen Teil 1 setup', group: 'Quiz setup' },
  ...
  'gt:sprechenCustomVortragsthemen': { label: 'Sprechen custom Vortragsthemen', group: 'Quiz setup' },
