...
function zeroAccuracyByType(): Record<QuizHistoryType, BucketStat> {
  return {
    ...
    'verb-stammformen': emptyBucket(),
    'verb-case-government': emptyBucket(),
    'prep-case': emptyBucket(),
    'prep-article': emptyBucket(),
    'prep-two-way': emptyBucket(),
    'prep-collocations': emptyBucket(),
    'dac-formation': emptyBucket(),
    'dac-match': emptyBucket(),
    'dac-substitution': emptyBucket(),
    'dac-neighbors': emptyBucket(),
    'dac-case': emptyBucket(),
    'dac-pronoun-case': emptyBucket(),
    'dac-article': emptyBucket(),
    'dac-transform': emptyBucket(),
    'dac-wo-question': emptyBucket(),
    'dac-dialogue': emptyBucket(),
    'dac-korrelat': emptyBucket(),
    'dac-paraphrase': emptyBucket(),
    'dac-contrast': emptyBucket(),
    'dac-sentence': emptyBucket(),
    'dac-assembly': emptyBucket(),
    'dac-answer': emptyBucket(),
    'dac-homograph': emptyBucket(),
    'dac-register': emptyBucket(),
    'dac-relative': emptyBucket(),
    'dw-hinher': emptyBucket(),
    'dw-compound': emptyBucket(),
    'dw-question': emptyBucket(),
    'dw-register': emptyBucket(),
    'dw-assembly': emptyBucket(),
    'dw-sentence': emptyBucket(),
    'dw-answer': emptyBucket(),
    'dw-lexical': emptyBucket(),
    'dw-idiom': emptyBucket(),
    'prep-sentence': emptyBucket(),
    'prep-remedial': emptyBucket(),
    'verb-sentence': emptyBucket(),
    'verb-remedial': emptyBucket(),
    ...
    'schreiben-teil1': emptyBucket(),
    'schreiben-teil2': emptyBucket(),
