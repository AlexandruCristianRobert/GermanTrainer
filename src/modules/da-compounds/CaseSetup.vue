...
const STORAGE_KEY = 'dacCaseSetup'
...
<template>
  <div class="page setup-page">
    <header class="section-header">
      <div>
        <div class="breadcrumb">Modul · Pronominaladverbien · Kasus</div>
        <h1 class="section-title">Case pick<em>.</em></h1>
        <p class="section-subtitle">
          A natural sentence already uses the da-compound — no gap to fill this time. Read it
          and pick the case its underlying collocation governs: Akkusativ or Dativ.
        </p>
      </div>
    </header>
