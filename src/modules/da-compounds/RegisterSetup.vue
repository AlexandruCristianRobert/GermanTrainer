...
import { filterRegisterItems } from '../../composables/useDaRegisterQuiz'
import { COLLOCATION_LEVELS, type CollocationLevel } from '../../data/collocations'

const STORAGE_KEY = 'dacRegisterSetup'
...
const availableItems = computed(() =>
  filterRegisterItems({ levels: levels.value }).length
)
...
<template>
  <div class="page setup-page">
    <header class="section-header">
      <div>
        <div class="breadcrumb">Modul · Pronominaladverbien · Register</div>
        <h1 class="section-title">Register<em>.</em></h1>
        <p class="section-subtitle">
          Is a da-/wo-compound phrase Standard German — fine in speech AND
          writing — merely <strong>gesprochen</strong> (colloquial, never
          written), or ungrammatical in every register? Judge each phrase raw,
          exactly as spoken.
        </p>
      </div>
    </header>
