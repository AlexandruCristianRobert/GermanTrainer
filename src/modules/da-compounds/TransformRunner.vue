  ...
  <div v-else-if="current && ready" class="page">
    <div class="sub-stage" ref="cardRef" tabindex="-1">
      ...
      <div class="sub-prompt">
        <p class="micro-mark sub-instruction">Ersetzen: Sache → da-Wort, Person → Präposition + Pronomen</p>
        <p class="sub-stem">
          {{ sentenceParts!.pre }}<strong class="sub-object">{{ sentenceParts!.object }}</strong>{{ sentenceParts!.post }}
        </p>
      </div>
