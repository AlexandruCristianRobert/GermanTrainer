...
import { filterRelativeItems } from '../../composables/useDaRelativeQuiz'
import { COLLOCATION_LEVELS, type CollocationLevel } from '../../data/collocations'

const STORAGE_KEY = 'dacRelativeSetup'
...
const availableItems = computed(() =>
  filterRelativeItems({ levels: levels.value }).length
)
...
<template>
  <div class="page setup-page">
    <header class="section-header">
      <div>
        <div class="breadcrumb">Modul · Pronominaladverbien · Relativsätze</div>
        <h1 class="section-title">Relative clauses<em>.</em></h1>
        <p class="section-subtitle">
          After a comma, the antecedent decides the link: an indefinite
          (alles, nichts, das Beste) demands the wo-form, a person forbids it
          — only Präposition + Relativpronomen works — and a concrete thing
          accepts both, "über das" or "worüber".
        </p>
      </div>
    </header>
