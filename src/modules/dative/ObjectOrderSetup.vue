...
import { filterObjectOrderItems } from '../../composables/useDativeDrill'
...
const STORAGE_KEY = 'datObjectOrderSetup'
...
const availableItems = computed(() =>
  filterObjectOrderItems({ levels: levels.value, kinds: kinds.value }).length
)
...
<template>
  <div class="page setup-page">
    <header class="section-header">
      <div>
        <div class="breadcrumb">Kapitel XIII · Dativ · Objektfolge</div>
        <h1 class="section-title">Objektfolge<em>.</em></h1>
        <p class="section-subtitle">
          Dativ before Akkusativ by default — but two pronouns flip it: <em>Ich gebe es
          ihm</em>, never *Ich gebe ihm es. With one pronoun, the pronoun goes first.
        </p>
      </div>
    </header>
    ...
    <div class="field">
      <div class="field-row">
        <div class="field-label">Art · {{ kinds.length }} of {{ KINDS.length }}</div>
        <div class="field-actions">
