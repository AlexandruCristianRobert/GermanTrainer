...
import { filterFormItems, DATIVE_FAMILIES, FAMILY_LABELS, type DativeFamily } from '../../composables/useDativeDrill'
...
const availableItems = computed(() =>
  filterFormItems({ levels: levels.value, families: families.value }).length
)
...
<template>
  <div class="page setup-page">
    <header class="section-header">
      <div>
        <div class="breadcrumb">Kapitel XIII · Dativ · Verb → Dativobjekt</div>
        <h1 class="section-title">Verb → dative object<em>.</em></h1>
