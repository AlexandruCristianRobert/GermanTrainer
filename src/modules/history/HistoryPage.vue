...
const QUIZ_TYPES: Record<QuizHistoryType, TypeMeta> = {
  ...
  'dac-homograph':    { label: 'Da-compounds · homographs', de: 'Da-Compounds · Doppelgänger', module: 'Da-Compounds' },
  'dac-register':     { label: 'Da-compounds · register', de: 'Da-Compounds · Register', module: 'Da-Compounds' },
  'dac-relative':     { label: 'Da-compounds · relative clauses', de: 'Da-Compounds · Relativsätze', module: 'Da-Compounds' },
  'dw-hinher':        { label: 'Direction words · hin or her', de: 'Hin & Her · Grundregel', module: 'Direction Words' },
  'dw-compound':      { label: 'Direction words · compounds', de: 'Hin & Her · Zusammensetzungen', module: 'Direction Words' },
  'dw-question':      { label: 'Direction words · wo/wohin/woher', de: 'Hin & Her · Fragewörter', module: 'Direction Words' },
  'dw-register':      { label: 'Direction words · register', de: 'Hin & Her · Kurzformen', module: 'Direction Words' },
  'dw-assembly':      { label: 'Direction words · assembly', de: 'Hin & Her · Satzbau', module: 'Direction Words' },
  'dw-sentence':      { label: 'Direction words · sentence (AI)', de: 'Hin & Her · Satz (KI)', module: 'Direction Words' },
  'dw-answer':        { label: 'Direction words · answer (AI)', de: 'Hin & Her · Antworten (KI)', module: 'Direction Words' },
  'dw-lexical':       { label: 'Direction words · lexicalized verbs', de: 'Hin & Her · Verblasste Richtung', module: 'Direction Words' },
  'dw-idiom':         { label: 'Direction words · idioms', de: 'Hin & Her · Redewendungen', module: 'Direction Words' },
  ...
  'relativ-pronomen':   { label: 'Relative pronouns',              de: 'Relativpronomen',             module: 'Grammatik' },
  'ndekl-form':         { label: 'Weak nouns',                     de: 'N-Deklination',               module: 'Grammatik' },
  ...
  'schreiben-teil1':    { label: 'Schreiben — Teil 1 Forumsbeitrag', de: 'Schreiben · Teil 1 Forumsbeitrag', module: 'Schreiben' },
  'schreiben-teil2':    { label: 'Schreiben — Teil 2 Nachricht',     de: 'Schreiben · Teil 2 Nachricht',  module: 'Schreiben' },
...
const typeOrder: QuizHistoryType[] = [
  ...
  'dac-homograph', 'dac-register', 'dac-relative',
