import{X as R,am as f,a8 as b,Y as a,a9 as u,aI as m,aJ as H,aK as O,d as $,E as l,K as S,af as B,Z as g,_ as k,l as h,D as I,S as E,T as M,G as N,aN as V,bl as K,av as W,aL as X,ae as Y,r as G,bm as J,H as Z,ah as q,bd as A}from"./index-w1ruU4HF.js";function F(e){const{textColor2:r,cardColor:o,modalColor:i,popoverColor:d,dividerColor:n,borderRadius:c,fontSize:t,hoverColor:s}=e;return{textColor:r,color:o,colorHover:s,colorModal:i,colorHoverModal:f(i,s),colorPopover:d,colorHoverPopover:f(d,s),borderColor:n,borderColorModal:f(i,n),borderColorPopover:f(d,n),borderRadius:c,fontSize:t}}const Q={common:R,self:F};function U(e){const{opacityDisabled:r,heightTiny:o,heightSmall:i,heightMedium:d,heightLarge:n,heightHuge:c,primaryColor:t,fontSize:s}=e;return{fontSize:s,textColor:t,sizeTiny:o,sizeSmall:i,sizeMedium:d,sizeLarge:n,sizeHuge:c,color:t,opacitySpinning:r}}const ee={common:R,self:U},oe=b([a("list",`
