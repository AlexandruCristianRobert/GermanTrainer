...
`,[m("splitor",`
 ...
 `)])]);function Ke(e,o,r){var i;const l=[];let p=!1;for(let s=0;s<e.length;++s){const d=e[s],c=(i=d.type)===null||i===void 0?void 0:i.name;c==="RadioButton"&&(p=!0);const a=d.props;if(c!=="RadioButton"){l.push(d);continue}if(s===0)l.push(d);else{const k=l[l.length-1].props,f=o===k.value,t=k.disabled,C=o===a.value,b=a.disabled,h=(f?2:0)+(t?0:1),S=(C?2:0)+(b?0:1),$={[`${r}-radio-group__splitor--disabled`]:t,[`${r}-radio-group__splitor--checked`]:f},w={[`${r}-radio-group__splitor--disabled`]:b,[`${r}-radio-group__splitor--checked`]:C},F=h<S?w:$;l.push(y("div",{class:[`${r}-radio-group__splitor`,F]}),d)}}return{children:l,isButtonGroup:p}}const We=Object.assign(Object.assign({},E.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),Je=j({name:"RadioGroup",props:We,setup(e){const o=A(null),{mergedSizeRef:r,mergedDisabledRef:i,nTriggerFormChange:l,nTriggerFormInput:p,nTriggerFormBlur:s,nTriggerFormFocus:d}=O(e),{mergedClsPrefixRef:c,inlineThemeDisabled:a,mergedRtlRef:k}=N(e),f=E("Radio","-radio-group",Ge,ce,e,c),t=A(e.defaultValue),C=M(e,"value"),b=L(C,t);function h(x){const{onUpdateValue:g,"onUpdate:value":n}=e;g&&R(g,x),n&&R(n,x),t.value=x,l(),p()}function S(x){const{value:g}=o;g&&(g.contains(x.relatedTarget)||d())}function $(x){const{value:g}=o;g&&(g.contains(x.relatedTarget)||s())}ae(se,{mergedClsPrefixRef:c,nameRef:M(e,"name"),valueRef:b,disabledRef:i,mergedSizeRef:r,doUpdateValue:h});const w=oe("Radio",k,c),F=H(()=>{const{value:x}=r,{common:{cubicBezierEaseInOut:g},self:{buttonBorderColor:n,buttonBorderColorActive:D,buttonBorderRadius:B,buttonBoxShadow:_,buttonBoxShadowFocus:I,buttonBoxShadowHover:P,buttonColor:V,buttonColorActive:G,buttonTextColor:K,buttonTextColorActive:W,buttonTextColorHover:Y,opacityDisabled:q,[U("buttonHeight",x)]:X,[U("fontSize",x)]:Z}}=f.value;return{"--n-font-size":Z,"--n-bezier":g,"--n-button-border-color":n,"--n-button-border-color-active":D,"--n-button-border-radius":B,"--n-button-box-shadow":_,"--n-button-box-shadow-focus":I,"--n-button-box-shadow-hover":P,"--n-button-color":V,"--n-button-color-active":G,"--n-button-text-color":K,"--n-button-text-color-hover":Y,"--n-button-text-color-active":W,"--n-height":X,"--n-opacity-disabled":q}}),u=a?re("radio-group",H(()=>r.value[0]),F,e):void 0;return{selfElRef:o,rtlEnabled:w,mergedClsPrefix:c,mergedValue:b,handleFocusout:$,handleFocusin:S,cssVars:a?void 0:F,themeClass:u==null?void 0:u.themeClass,onRender:u==null?void 0:u.onRender}},render(){var e;const{mergedValue:o,mergedClsPrefix:r,handleFocusin:i,handleFocusout:l}=this,{children:p,isButtonGroup:s}=Ke(Be(Te(this)),o,r);return(e=this.onRender)===null||e===void 0||e.call(this),y("div",{onFocusin:i,onFocusout:l,ref:"selfElRef",class:[`${r}-radio-group`,this.rtlEnabled&&`${r}-radio-group--rtl`,this.themeClass,s&&`${r}-radio-group--button-group`],style:this.cssVars},p)}});export{qe as N,Ze as a,Je as b,Xe as c,Ie as d,ce as r};
