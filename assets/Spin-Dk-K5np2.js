import{H as R,aE as f,U as b,S as a,a6 as u,T as m,aW as H,aX as B,d as $,K as l,M as S,az as D,Z as g,O as k,l as h,I,a0 as M,P as E,z as N,A as V,bm as K,aL as W,aa as X,ay as A,r as U,bn as Y,ak as Z,ae as q,bi as F}from"./index-VVK-nuYI.js";function G(e){const{textColor2:r,cardColor:o,modalColor:i,popoverColor:d,dividerColor:n,borderRadius:c,fontSize:t,hoverColor:s}=e;return{textColor:r,color:o,colorHover:s,colorModal:i,colorHoverModal:f(i,s),colorPopover:d,colorHoverPopover:f(d,s),borderColor:n,borderColorModal:f(i,n),borderColorPopover:f(d,n),borderRadius:c,fontSize:t}}const J={common:R,self:G};function Q(e){const{opacityDisabled:r,heightTiny:o,heightSmall:i,heightMedium:d,heightLarge:n,heightHuge:c,primaryColor:t,fontSize:s}=e;return{fontSize:s,textColor:t,sizeTiny:o,sizeSmall:i,sizeMedium:d,sizeLarge:n,sizeHuge:c,color:t,opacitySpinning:r}}const ee={common:R,self:Q},oe=b([a("list",`
 ...
 `)])]),se={small:20,medium:18,large:16},te=Object.assign(Object.assign(Object.assign({},g.props),{contentClass:String,contentStyle:[Object,String],description:String,size:{type:[String,Number],default:"medium"},show:{type:Boolean,default:!0},rotate:{type:Boolean,default:!0},spinning:{type:Boolean,validator:()=>!0,default:void 0},delay:Number}),Y),de=$({name:"Spin",props:te,slots:Object,setup(e){const{mergedClsPrefixRef:r,inlineThemeDisabled:o}=S(e),i=g("Spin","-spin",ie,ee,e,r),d=h(()=>{const{size:s}=e,{common:{cubicBezierEaseInOut:v},self:p}=i.value,{opacitySpinning:x,color:y,textColor:z}=p,C=typeof s=="number"?Z(s):p[q("size",s)];return{"--n-bezier":v,"--n-opacity-spinning":x,"--n-size":C,"--n-color":y,"--n-text-color":z}}),n=o?k("spin",h(()=>{const{size:s}=e;return typeof s=="number"?String(s):s[0]}),d,e):void 0,c=F(e,["spinning","show"]),t=U(!1);return A(s=>{let v;if(c.value){const{delay:p}=e;if(p){v=window.setTimeout(()=>{t.value=!0},p),s(()=>{clearTimeout(v)});return}}t.value=c.value}),{mergedClsPrefix:r,active:t,mergedStrokeWidth:h(()=>{const{strokeWidth:s}=e;if(s!==void 0)return s;const{size:v}=e;return se[typeof v=="number"?"medium":v]}),cssVars:o?void 0:d,themeClass:n==null?void 0:n.themeClass,onRender:n==null?void 0:n.onRender}},render(){var e,r;const{$slots:o,mergedClsPrefix:i,description:d}=this,n=o.icon&&this.rotate,c=(d||o.description)&&l("div",{class:`${i}-spin-description`},d||((e=o.description)===null||e===void 0?void 0:e.call(o))),t=o.icon?l("div",{class:[`${i}-spin-body`,this.themeClass]},l("div",{class:[`${i}-spin`,n&&`${i}-spin--rotate`],style:o.default?"":this.cssVars},o.icon()),c):l("div",{class:[`${i}-spin-body`,this.themeClass]},l(W,{clsPrefix:i,style:o.default?"":this.cssVars,stroke:this.stroke,"stroke-width":this.mergedStrokeWidth,radius:this.radius,scale:this.scale,class:`${i}-spin`}),c);return(r=this.onRender)===null||r===void 0||r.call(this),o.default?l("div",{class:[`${i}-spin-container`,this.themeClass],style:this.cssVars},l("div",{class:[`${i}-spin-content`,this.active&&`${i}-spin-content--spinning`,this.contentClass],style:this.contentStyle},o),l(X,{name:"fade-in-transition"},{default:()=>this.active?t:null})):t}});export{le as N,ae as a,de as b};
