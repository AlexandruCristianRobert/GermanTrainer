...
`,[d("input, textarea",`
 ...
 `),k("&:-webkit-autofill ~",[d("placeholder","display: none;")])]),D("round",[Q("textarea","border-radius: calc(var(--n-height) / 2);")]),d("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),k("&:hover",[d("state-border","border: var(--n-border-hover);")]),D("focus","background-color: var(--n-color-focus);",[d("state-border",`
